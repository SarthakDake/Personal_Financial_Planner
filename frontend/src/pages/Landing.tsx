    ...
    <div className="min-h-screen bg-mesh relative overflow-hidden dark">
      ...
      <header className="relative mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-accent text-[#0d0d0d] font-display text-2xl glow-blue">
            W
          </div>
      ...
      <section className="relative mx-auto grid max-w-6xl gap-10 px-6 pb-20 pt-10 md:grid-cols-[1.1fr_0.9fr] md:items-center md:pt-16">
        <div className="animate-fade-up">
          <div className="inline-flex items-center gap-2 rounded-full border border-cyan-400/30 bg-cyan-400/10 px-3 py-1 text-xs text-[#00D1FF] mb-4">
            <TrendingUp className="h-3.5 w-3.5" />
            Neon charcoal desk for advisors
          </div>
          <h1 className="font-display text-5xl leading-[1.05] text-white md:text-6xl glow-cyan-text">
            WealthCraft
          </h1>
        ...
        <div className="animate-fade-up delay-2 relative min-h-[300px] rounded-3xl border border-cyan-500/25 bg-gradient-to-br from-[#1a1a1a] via-[#121212] to-[#0a1a1f] p-8 text-white glow-blue">
          <div className="font-display text-3xl text-[#e8fbff]">Clarity. Discipline. Prosperity.</div>
            ...
            {[
              ...
              <div key={item.text} className="flex items-start gap-3 text-sm text-slate-200">
                <div className="rounded-lg bg-accent/15 p-1.5">
                  <item.icon className="h-4 w-4 text-[#00D1FF]" />
                </div>
                <span>{item.text}</span>
              </div>
            ))}
          ...
          <div className="mt-8 grid grid-cols-3 gap-3 text-center">
            {[
              ...
              <div key={k} className="rounded-xl bg-[#0d0d0d]/70 border border-cyan-500/20 py-3">
                <div className="text-[10px] uppercase tracking-wider text-slate-400">{k}</div>
                <div className="mt-1 text-lg font-semibold text-[#00D1FF]">{v}</div>
              </div>
            ))}
          </div>
        </div>
